...
sed -e "s/^AC_INIT(.*/AC_INIT([libwdi], [$MAJOR.$MINOR.$MICRO], [libusb-devel@lists.sourceforge.net], [libwdi], [http:\/\/libusb.org\/wiki\/windows_backend])/" configure.ac > configure.ac~
